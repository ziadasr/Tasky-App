        ...
        return this.trace(enums_1.SpanKind.CONSUMER, 'process', this.name, async (span) => {
            ...
            try {
                ...
                if (unrecoverableErrorMessage) {
                    const failed = await this.retryIfFailed(() => this.handleFailed(new errors_1.UnrecoverableError(unrecoverableErrorMessage), job, token, fetchNextCallback, jobsInProgress, inProgressItem, span), { delayInMs: this.opts.runRetryDelay, span });
                    return failed;
                }
